...
const EmployeeDashboardPage = () => {
  return (
    <div style={{ background: appConfig.colors.surface, borderRadius: 20, boxShadow: '0 16px 40px rgba(0,0,0,0.06)', border: `1px solid ${appConfig.colors.border}`, padding: '2rem' }}>
      <h1 style={{ margin: 0, fontSize: '2rem', fontWeight: 700 }}>Employee Dashboard</h1>
      <p style={{ marginTop: '0.75rem', color: appConfig.colors.textMuted }}>Attendance, performance, and employment data will appear here.</p>
